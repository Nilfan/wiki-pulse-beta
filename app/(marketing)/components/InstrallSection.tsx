      ...
      <div className="border border-ink bg-ink text-paper p-[clamp(22px,3vw,34px)]">
        <h2
          className={clsx(
            ...
            "font-medium text-[clamp(16px,2vw,21px)] tracking-[-0.06em] mx-0 mt-0 mb-1.5",
          )}
        >
        ...
        <p className="mx-0 mt-0 mb-5 text-[#A9AFB4] text-[14.5px] max-w-[75%] min-[901px]:max-w-full">
          ...
          <code className={clsx(jetBrainsMono.className, "text-[13px]")}>
            pulse()
          </code>{" "}
        ...
        <div className="flex items-center gap-3.5 bg-[#20242A] border border-[#333940] px-3.75 py-3.25 overflow-x-auto">
          <code
            className={clsx(
              ...
              "text-[12.5px] text-[#D7DBDE] whitespace-nowrap",
            )}
          >
          ...
          <button
            className={clsx(
              jetBrainsMono.className,
              "ml-auto flex-none bg-transparent border border-[#4A5158] text-[#A9AFB4] text-[11px] px-2.75 py-1.5",
            )}
          >
            Copy
          </button>
